...
export function OwnerSettingsForm({ user }: { user: User }) {
      ...
      <div className="lg:col-span-3 space-y-8">
          ...
          >
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-sm text-slate-500 mb-2">Member since recently</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="space-y-2">
                ...
                <Input defaultValue={user.name} className="h-11 bg-white/5 border-white/5 text-white rounded-xl focus:ring-indigo-500/50" />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Email Address</label>
                <Input defaultValue={user.email} disabled className="h-11 bg-white/5 border-white/5 text-slate-400 rounded-xl focus:ring-indigo-500/50 cursor-not-allowed" />
              </div>
            </div>
        ...
        {activeSection !== "profile" && (
          <div className="bg-white/5 border border-white/10 rounded-3xl p-20 text-center">
            <p className="text-slate-500">Section {activeSection} is coming soon.</p>
          </div>
        )}
