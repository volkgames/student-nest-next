...
const chats = [
  { id: 1, name: "Sami Ben Ali", lastMsg: "Is the studio still available for July?", time: "2m ago", unread: 2, avatar: "SB" },
  { id: 2, name: "Leila Dridi", lastMsg: "Thank you! See you tomorrow.", time: "1h ago", unread: 0, avatar: "LD" },
  { id: 3, name: "Yassine Mansour", lastMsg: "Can I bring a pet?", time: "3h ago", unread: 0, avatar: "YM" },
  { id: 4, name: "Amira Kotti", lastMsg: "I sent the deposit receipt.", time: "Yesterday", unread: 0, avatar: "AK" },
];
        ...
        <div className="p-6 border-b border-white/5">
          <div className="relative">
            ...
            <Input 
              ...
              className="pl-9 h-9 bg-white/5 border-white/5 text-white text-xs rounded-xl focus-visible:ring-indigo-500/50"
            />
          </div>
        </div>
          ...
          {chats.map((chat) => (
            <button
              ...
              className={cn(
                ...
                selectedChat.id === chat.id && "bg-white/5 after:absolute after:left-0 after:top-0 after:bottom-0 after:w-1 after:bg-indigo-500"
              )}
            >
              ...
              {chat.unread > 0 && (
                <span className="h-4 w-4 bg-indigo-600 text-[9px] font-black text-white rounded-full flex items-center justify-center shadow-lg shadow-indigo-600/30">
                  {chat.unread}
                </span>
              )}
            </button>
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-slate-950/10 relative z-10">
        ...
        <div className="h-16 px-6 border-b border-white/5 flex items-center justify-between bg-white/2 backdrop-blur-md">
          <div className="flex items-center gap-4">
            <div className="h-9 w-9 rounded-xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-bold text-xs">
              {selectedChat.avatar}
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar">
          <div className="flex flex-col gap-1 items-end">
            <div className="bg-indigo-600 text-white p-4 rounded-2xl rounded-tr-none max-w-[70%] text-sm font-medium shadow-xl shadow-indigo-600/20">
              Hello Sami! Yes, the studio is available for July. Are you interested in a visit?
            </div>
            <span className="text-[9px] text-slate-500 font-bold uppercase mr-1">10:15 AM <CheckCheck className="h-3 w-3 inline ml-1 text-indigo-400" /></span>
          </div>
          ...
          <div className="flex flex-col gap-1 items-start">
            <div className="bg-white/10 text-white p-4 rounded-2xl rounded-tl-none max-w-[70%] text-sm font-medium border border-white/5">
              Awesome! Can I come this afternoon around 2:30 PM?
            </div>
          ...
          <div className="flex flex-col gap-1 items-end">
            ...
            <span className="text-[9px] text-slate-500 font-bold uppercase mr-1">10:18 AM <CheckCheck className="h-3 w-3 inline ml-1 text-indigo-400" /></span>
          </div>
        </div>
        ...
        <div className="p-6 bg-white/2 backdrop-blur-md border-t border-white/5">
          <form className="flex items-center gap-3" onSubmit={(e) => e.preventDefault()}>
            ...
            <Input 
              ...
              className="flex-1 h-11 bg-white/5 border-white/5 text-white placeholder:text-slate-600 rounded-xl focus-visible:ring-indigo-500/50"
            />
            <Button type="submit" className="h-11 w-11 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-600/20 shrink-0">
